...
$sth = $pdo->prepare('SELECT *from produtos p INNER JOIN categorias c on c.cat_id = p.cat_id where id = :id');
...
<div class="col s6">
<label>Nome</label></br>
<input type="text" required="required" name="pro_nome" value="<?= $pro_nome;?>"/></div>
<div class="col s6">
<label>Descrição</label></br>
<input type="text" required="required" name="pro_descricao" value="<?= $pro_descricao;?>"/></div>
<div class="col s6">
<label>Preço</label></br>
<input type="text" required="required" name="pro_preco" value="<?= $pro_preco;?>"/>
</div>
...
<label>Categoria</label></br>
                        ...
                        $sth->execute(); ?>
                        <select required="required" class="browser-default" name="cat_id" id="cat_id">
