...
if ($_SESSION['Lanche']['nivel'] != 1) {
    define("LINK0", "../funcionarios/home");
}
define("LINK1", "../img");
?>
...
<!-- OPÇÕES  -->
    ...
    <div class="container" >
        ...
        <div class="col s12 m12" style="margin-bottom:-25px;">
                <ul>
                    <a href="adicionarCategoria/categoria.php">
                        <center><img id="efeito" src="../img/newicons/categorias.png"></center>
                    </a>
                </ul>
            </div>
            <div class="col s12 m12" style="margin-bottom:-25px;">
                <ul>
                    <a href="adicionarProdutos/produtos.php">
                        <center><img id="efeito" src="../img/newicons/produtos.png"></center>
                    </a>
                </ul>
            </div>
             <div class="col s12 m12" style="margin-bottom:-25px;">
                <ul>
                    <a href="adicionarMesa/mesa.php">
                        <center><img id="efeito" src="../img/newicons/mesas.png"></center>
                    </a>
                </ul>
            </div>
            <div class="col s12 m12" style="margin-bottom:-25px;">
                <ul>
                    <a href="cargos/cargos.php">
                        <center><img id="efeito" src="../img/newicons/cargos.png"></center>
                    </a>
                </ul>
            </div>
             <div class="col s12 m12" style="margin-bottom:-25px;">
                <ul>
                    <a href="funcionarios/verificarFuncionarios.php">
                        <center><img id="efeito" src="../img/newicons/pessoascircle.png"></center>
                    </a>
                </ul>
            </div>
            ...
            <div class="col s12 m12" style="margin-bottom:-25px;">
                <ul>
                    <a href="../caixa admin/home.php">
                        <center><img id="efeito" src="../img/newicons/finalizar.png"></center>
                    </a>
                </ul>
            </div>
        </div>
